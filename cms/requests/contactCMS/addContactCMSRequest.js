...
/**
 * Validations for add contact cms
 */
class addContactCMSRequest {
   ...
   */
  validate() {
    const { error, value } = addContactCMSRequest.schema.validate(this.data);
    if (error) {
...
export default addContactCMSRequest;
